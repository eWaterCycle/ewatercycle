...
def _grdc_metadata_reader(grdc_station_path, all_lines):
    ...
    if id_from_grdc is not None:
        ...
        attribute_grdc["file_generation_date"] = _extract_metadata(all_lines,
        ...
        attribute_grdc["grdc_latitude_in_arc_degree"] = _extract_metadata(all_lines,
                                                                          "Latitude (DD)",
                                                                          cast=float)
        attribute_grdc["grdc_longitude_in_arc_degree"] = _extract_metadata(all_lines,
                                                                           "Longitude (DD)",
                                                                           cast=float)
        attribute_grdc["grdc_catchment_area_in_km2"] = _extract_metadata(all_lines,
                                                                         "Catchment area (km²)",
                                                                         cast=float)
        ...
        attribute_grdc["units"] = _extract_metadata(all_lines,
                                                    "Unit of measure")
        attribute_grdc["Owner of original data"] = _extract_metadata(all_lines,
